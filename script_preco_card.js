...
var card = document.querySelectorAll('.listagem-linha');


card.forEach(function (carditem) {
    var classesDesconto = carditem.querySelectorAll('.desconto-a-vista');
    ...
    classesDesconto.forEach(function (elemento) {
        ...
        <style type="text/css">
        <![CDATA[
            .fil00 {fill:#FEFEFE;fill-rule:nonzero}
        ]]>
        </style>
        </defs>
        <g id="Camada_x0020_1">
